...
# curl https://raw.githubusercontent.com/WeslieDE/MinecraftBedrockServer/master/SetupMinecraft.sh | bash
#
# GitHub Repository: https://github.com/WeslieDE/MinecraftBedrockServer

echo "Minecraft Bedrock Server installation script by James A. Chambers"
echo "Latest version always at https://github.com/WeslieDE/MinecraftBedrockServer"
...
Update_Scripts() {
  ...
  curl -H "Accept-Encoding: identity" -L -o start.sh https://raw.githubusercontent.com/WeslieDE/MinecraftBedrockServer/master/start.sh
  chmod +x start.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o stop.sh https://raw.githubusercontent.com/WeslieDE/MinecraftBedrockServer/master/stop.sh
  chmod +x stop.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o restart.sh https://raw.githubusercontent.com/WeslieDE/MinecraftBedrockServer/master/restart.sh
  chmod +x restart.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o fixpermissions.sh https://raw.githubusercontent.com/WeslieDE/MinecraftBedrockServer/master/fixpermissions.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o revert.sh https://raw.githubusercontent.com/WeslieDE/MinecraftBedrockServer/master/revert.sh
  chmod +x revert.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o clean.sh https://raw.githubusercontent.com/WeslieDE/MinecraftBedrockServer/master/clean.sh
  chmod +x clean.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o update.sh https://raw.githubusercontent.com/WeslieDE/MinecraftBedrockServer/master/update.sh
  chmod +x update.sh
...
Update_Service() {
  ...
  sudo curl -H "Accept-Encoding: identity" -L -o /etc/systemd/system/$ServerName.service https://raw.githubusercontent.com/WeslieDE/MinecraftBedrockServer/master/minecraftbe.service
...
Check_Architecture() {
  ...
  if [[ "$CPUArch" == *"aarch"* ]]; then
    ...
    curl -H "Accept-Encoding: identity" -L -o depends.zip https://raw.githubusercontent.com/WeslieDE/MinecraftBedrockServer/master/depends.zip
    unzip depends.zip
    sudo mkdir /lib64
